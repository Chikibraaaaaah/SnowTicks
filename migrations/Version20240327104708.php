 ...
 */
final class Version20240327104708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL, DROP user_name, DROP img_url, DROP role, DROP created_at, DROP updated_at, CHANGE email email VARCHAR(180) NOT NULL');
